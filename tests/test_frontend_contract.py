...
class FrontendContractTests(unittest.TestCase):
    ...
    def test_report_export_uses_a_stable_preview_with_pdf_save_action(self) -> None:
        ...
        self.assertIn("reportExportCoolingDown", self.app_js)
        self.assertIn("startReportExportCooldown", self.app_js)
        self.assertIn("loadFrontendRuntimeConfig", self.app_js)
        self.assertIn("/frontend-config", self.app_js)
        self.assertIn("reportExportCooldownMs", self.app_js)
        self.assertIn("exportingReport || reportExportCoolingDown", self.html)
    ...
    def test_sample_download_entry_near_upload(self) -> None:
        ...
        self.assertIn('src="/assets/guideSources/upload-demo.mp4"', self.guide_html)
        self.assertIn("guide-demo-video", self.guide_html)
    ...
    def test_sample_download_opens_guide_subpage(self) -> None:
        ...
        self.assertIn("updateSampleSizes()", self.guide_html)
        self.assertIn("visibilitychange", self.guide_html)
        self.assertIn("/assets/guide.md", self.guide_html)
        self.assertIn("guide-sample-meta", self.guide_html)
